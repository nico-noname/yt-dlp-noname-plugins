# ==============================================================================
# Based on: https://github.com/c-basalt/yt-dlp/blob/rplay-native/yt_dlp/extractor/rplaylive.py
# Original c-basalt
# ==============================================================================
    ...
    def _perform_login(self, username, password):
        if '@' in username:
            ...
            if traverse_obj(result, 'success'):
                ...
                self.write_debug(f'rplaylive refresh_token: {self._refresh_token}')
            else:
